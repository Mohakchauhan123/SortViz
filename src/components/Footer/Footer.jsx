    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-text">
          <p>&copy; 2024 SortVizHub. All rights reserved.</p>
          <p>Designed and developed by @Ishita</p>
        </div>
        <div className="footer-icons">
          <a href="https://github.com/IshitaSaraswat03" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.linkedin.com/in/ishita-saraswat03/" target="_blank" rel="noopener noreferrer">
